...
COOKIE_AGE = 60 * 60 *24 *7     # 일주일 유효기간 설정

@app.route('/')
def home():
    return render_template('index.html')

@app.get('/login')      # 방문횟수 늘리는
def loginfunc():
    ...
    if name:
        ...
        msg = f'안녕하세요 {name}님 {visits}번째 방문이셔'
    else:
        visits = None
        msg = '이름을 입력하면 방문횟수를 쿠키로 기억할게'
